  ...
  return (
    <Container>
        ...
        <InfoBox>
            ...
            <TextBox>
                <TextLine>At <span>ZEPHYRS</span>, we craft timepieces that transcend trends. From the timeless elegance of "Native" to the industrial strength of "Worker" and the powerful allure of "Amplifier," each watch is a fusion of heritage, innovation, and enduring sophistication.</TextLine>
